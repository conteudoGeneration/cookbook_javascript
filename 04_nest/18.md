...
**Linhas 9 a 12:** No array **imports**, vamos adicionar a **Classe AuthModule** do **Módulo Auth**. Dessa forma, a classe de serviço **Bcrypt** poderá ser injetada em outras classes dentro do **Módulo Usuario**. Observe que utilizamos na importação da Classe AuthModule o método **forwardRef()**, para evitar o erro de referência circular, porque AuthModule utilizará UsuarioModule e vice-versa.
