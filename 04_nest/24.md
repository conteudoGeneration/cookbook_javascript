...
> [!CAUTION]
>
> **O parâmetro Endereço do Endpoint (primeiro parâmetro do método setup), não pode ficar vazio ou ser preenchido com uma /, senão o Swagger não irá funcionar.**
...
> [!IMPORTANT]
>
> **O Token está configurado para durar 1h, ou seja, daqui a 1h você terá que repetir o processo acima para desbloquear o Swagger novamente.**
