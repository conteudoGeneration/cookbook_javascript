...
<h3>1.2.1. O MySQL Workbench não possui nenhuma conexão disponível</h3>
...
6. Se a conexão for bem sucedida, será aberta a janela principal do **MySQL Workbench**. onde desenvolveremos as nossas instruções SQL.
