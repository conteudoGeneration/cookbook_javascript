...
```js
console.log("%formato_0 %formato_1 %formato_N texto", variável_0, variável_1, ..., variavel_N);
```
...
<div align="left"><img src="https://i.imgur.com/JACNZiR.png" title="source: imgur.com" width="5%"/> <a href="https://github.com/rafaelq80/exemplos_js/tree/main/javascript/entrada_saida" target="_blank"><b>Código Fonte dos Exemplos</b></a></div>
