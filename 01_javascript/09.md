...
TypeScript é uma linguagem de programação criada pela Microsoft. Na prática ele é um _superset_ do ECMAScript que, por sua vez, é um *superset* do JavaScript Clássico. Isso significa que praticamente qualquer código escrito em JavaScript também é um código TypeScript. 

O código TypeScript, diferente de outras linguagens, ele é transpilado e convertido para ECMAScript (JavaScript). Por isso, pode ser utilizado normalmente em qualquer projeto JavaScript.
...
Para criar um código TypeScript, primeiro você escreve o código utilizando as Estruturas oferecidas pelo TypeScript, e em seguida, você transpila (traduz) o código TypeScript em código JavaScript, através do transpiler do TypeScript. Depois de gerar o código JavaScript, você pode utilizar este código em qualquer ambiente que execute JavaScript, como o seu navegador ou no Terminal, por exemplo. O diagrama a seguir mostra o processo de Transpilação do  TypeScript para o JavaScript:

<div align="center"><img src="https://i.imgur.com/lsrVR4x.png" title="source: imgur.com" /></div>

Observe que os arquivos TypeScript utilizam a extensão `.ts`, ao invés da extensão `.js`, utilizada pelos arquivos JavaScript. 
...
<h3>2.1. Automatizando a Execução do Código</h3>
