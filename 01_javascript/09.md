...
Quando falamos de Matrizes no JavaScript, nativamente não existem Matrizes propriamente ditas, mas você pode simplesmente criar um Vetor composto por "Vetores Empilhados". A ideia básica seria primeiro você cria um Vetor com tamanho fixo e depois você define cada elemento deste Vetor como um novo Array com o tamanho pré definido.

<div align="center"><img src="https://i.imgur.com/vsIQ3nB.png" title="source: imgur.com" /></div>
...
Observe que para definir o número de linhas da Matriz, utilizaremos o Método **Array()**. Para definir o número de colunas da Matriz, utilizaremos um Laço de Repetição que será responsável por criar um Vetor em cada linha, através do Método **Array()**. O Tamanho de cada vetor será equivalente ao número de Colunas da Matriz.
...
No caso da **Matriz Quadrada (3x3)**, o número de linhas e colunas serão iguais.
...
No caso da **Matriz Irregular (3x2)**, o número de linhas é diferente do numero de colunas. Observe que os vetores criados no Laço de Repetição possuem um tamanho diferente do vetor criado fora do Laço de Repetição.
