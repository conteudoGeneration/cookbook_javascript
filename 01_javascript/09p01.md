...
Para acessar os dados armazenados em uma posição do vetor utilizaremos o **nome do vetor seguido por um par de colchetes**. Dentro dos colchetes, informaremos o **índice do vetor**, ou seja, a posição que desejamos visualizar os dados armazenados.
