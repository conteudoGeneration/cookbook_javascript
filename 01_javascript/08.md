...
Assim como nos Laços Condicionais, as variáveis criadas com o **let** serão tratadas como variáveis de **Escopo de Local**, enquanto as variáveis criadas com o **var** serão tratadas como variáveis de **Escopo Global**.

<br />

<h2>1. Tipos de Laços de Repetição</h2>

Em JavaScript, existem 3 Laços de Repetição ou Loops principais:
...
## <img src="https://i.imgur.com/8eYS3Y6.png" title="source: imgur.com" width="3%"/>**Exemplo 01 - Laço de Repetição FOR**
...
**Código em JavaScript - Versão sem o Laço de Repetição FOR:**
...
**Código em JavaScript - Versão com Laço de Repetição FOR:**
...
<div align="left"><img src="https://i.imgur.com/JACNZiR.png" title="source: imgur.com" width="4%"/> <a href="https://github.com/rafaelq80/exemplos_js/tree/main/javascript/repeticao" target="_blank"><b>Código fonte dos exemplos</b></a></div>
