...
Nativamente, o TypeScript/JavaScript possui apenas 3 **Collections**:

- Array
- Set
- Map

A Collection **Array** funciona da mesma forma que um Array tradicional: **Todos os elementos são ordenados  sequencialmente**. Para acessar um determinado elemento da lista, utilizamos o número do índice, que indica a posição onde o elemento está armazenado. Um dos grande benefícios da Collection Array é que o usuário tem controle total sobre qual elemento e onde este elemento está inserido na lista. O Método Construtor da Classe Array permite criar um array com tamanho fixo ou dinâmico, além de definir o tipo de dado que será armazenado no array, que pode ser primitivo ou objeto. 
...
Em nosso curso, vamos estudar mais a fundo a C Array, por se tratar de uma escolha natural quando for necessário usar uma estrutura sequencial redimensionável indexada,  o que a torna ideal para o acesso aleatório aos dados armazenados.
