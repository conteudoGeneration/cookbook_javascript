...
Com relação à todos conteúdos vistos até agora com a Linguagem JavaScript, a principal mudança ao utilizar a Linguagem TypeScript será a tipagem das variáveis, constantes e vetores. Entretanto, existem algumas outras diferenças que são específicas da Linguagem TypeScript. Na tabela abaixo vemos um resumo do que muda e o que permanecerá igual:
