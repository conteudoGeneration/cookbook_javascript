...
| <img src="https://i.imgur.com/oScAYGc.png" title="source: imgur.com" width="100px"/> | <div align="left"> **ATENÇÃO:** *Observe que a Biblioteca readline-sync, não lida corretamente com caracteres acentuados. Não se preocupe com isso agora, porque no final do projeto, depois que aprendermos a trabalhar com Programação Assíncrona, faremos a correção da acentuação da Biblioteca readline-sync.*</div> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
