...
Um dos recursos que diferencia o TypeScript do JavaScript é o suporte ao **Estreitamento de Tipos** (**Narrowing**), que permite acessar propriedades e métodos que só estão disponíveis em determinados tipos e também ajuda o  TypeScript a detectar erros e bugs em tempo de compilação.
